<div class="page-header">
  <h1>ownCloud Contributor Conference Updates</h1>
</div>
<p>The <a href="/conf">ownCloud Contributor Conference</a> is coming in September 2016. Subscribe below to status updates about the opening of registration, call for papers and more! We won't spam, this is just for the conference. If you're interested in other news, check <a href="/newsletter">our newsletter</a> or other <a href="/promote">conversation channels</a>!</p>
   ...
   <div style="color:#5b5b5b; background-color:#e8e8e8; border-radius:5px;">
       ...
       <form data-id="embedded_signup:form" class="ctct-custom-form Form" name="embedded_signup" method="POST" action="https://visitor2.constantcontact.com/api/signup">
           ...
           <button type="submit" class="Button ctct-button Button--block Button-secondary" data-enabled="enabled">Sign Up</button>
                <div><p class="ctct-form-footer">By submitting this form, you are granting: ownCloud, 57 Bedford St, Lexington, Massachusetts, 02420, United States, http://www.owncloud.com permission to email you. You may unsubscribe via the link found at the bottom of every email.  (See our <a href="http://www.constantcontact.com/legal/privacy-statement" target="_blank">Email Privacy Policy</a> for details.) Emails are serviced by Constant Contact.</p></div>
       </form>
   </div>
</div>
