...
<ul>
<li>OAuth2 authentication support by opening external browser (<a href='https://github.com/owncloud/client/pull/5668'>#5668</a>)</li>
...
<li>Sharing: Show warning that links are public (<a href='https://github.com/owncloud/client/pull/5747'>#5747</a>)</li>
<li>Sharing: Sharing dialog redesign: multiple share links support (<a href='https://github.com/owncloud/client/pull/5695'>#5695</a>)</li>
...
<li>Gui: Display the user server avatar (<a href='https://github.com/owncloud/client/pull/5482'>#5482</a>)</li>
...
<li>Gui: Allow to add multiple sync folder connection of the same folder (<a href='https://github.com/owncloud/client/pull/6032'>#6032</a>)</li>
<li>Activity: Link errors from the account tab, allow filtering by account/folder (<a href='https://github.com/owncloud/client/pull/5861'>#5861</a>)</li>
<li>Activity: Present conflicts more prominently (<a href='https://github.com/owncloud/client/pull/5894'>#5894</a>)</li>
<li>Activity: Allow sorting the columns in Sync Protocol tab (<a href='https://github.com/owncloud/client/pull/6093'>#6093</a>)</li>
<li>Selective Sync: Open sub folder context menu (<a href='https://github.com/owncloud/client/issues/5596'>#5596</a>)</li>
<li>Selective Sync: Skip excluded folders when reading db (<a href='https://github.com/owncloud/client/pull/5772'>#5772</a>)</li>
...
<li>Excludes: Remove <tt>.htaccess</tt> form list of excluded files (<a href='https://github.com/owncloud/client/issues/5701'>#5701</a>)</li>
<li>Excludes: Hardcode <tt>desktop.ini</tt></li>
<li>Excludes: Allow escaping "<tt>#</tt>" (<a href='https://github.com/owncloud/client/issues/6012'>#6012</a>)</li>
<li>Excludes: Use faster matching via QRegularExpression (<a href='https://github.com/owncloud/client/pull/6063'>#6063</a>)</li>
<li>Discovery: Increase the <tt>MAX_DEPTH</tt> and show deep folders as ignored (<a href='https://github.com/owncloud/client/issues/1067'>#1067</a>)</li>
...
<li>Overlay Icons: Update right after sharing (<a href='https://github.com/owncloud/client/pull/6115'>#6115</a>)</li>
...
<li>Credentials: Namespace  (<a href='https://github.com/owncloud/client/pull/6126 '>#6126</a>)</li>
...
<li>Sync: Dynamic sizing of chunks in chunked uploads for improved big file upload performance (<a href='https://github.com/owncloud/client/pull/5852'>#5852</a>)</li>
...
<li>Sync: Upload conflict files if <tt>OWNCLOUD_UPLOAD_CONFLICT_FILES</tt> environment variable is set (<a href='https://github.com/owncloud/client/pull/6038'>#6038</a>)</li>
...
<li>Logging improvements (With Qt logging categories) (<a href='https://github.com/owncloud/client/pull/5671'>#5671</a>)</li>
...
<li>HTTP: Send a unique <tt>X-Request-ID</tt> with each request (<a href='https://github.com/owncloud/client/issues/5853'>#5853</a>)</li>
<li>HTTP: Support HTTP2 when built and running with Qt 5.9.x (Official packages still on Qt 5.6.x) (<a href='https://github.com/owncloud/client/pull/5659'>#5659</a>)</li>
<li>owncloudcmd: Don't start if connection or auth fails (<a href='https://github.com/owncloud/client/issues/5692'>#5692</a>)</li>
<li>csync: Switch build from C to C++ (<a href='https://github.com/owncloud/client/pull/5978'>#5978</a>, <a href='https://github.com/owncloud/client/pull/6033'>#6033</a>)</li>
...
<li>csync: Switch to using upper layer SyncJournalDB (<a href='https://github.com/owncloud/client/pull/6087'>#6087</a>)</li>
<li>Switch 3rdparty/json usage to Qt5's QJson (<a href='https://github.com/owncloud/client/issues/5710'>#5710</a>)</li>
<li>OpenSSL: Don't require directly, only via Qt (<a href='https://github.com/owncloud/client/pull/5833'>#5833</a>)</li>
<li>Remove iconv dependency, use Qt for file system locale encoding/decoding (emoji filename support on macOS) (<a href='https://github.com/owncloud/client/pull/5875'>#5875</a>)</li>
<li>Compilation: Remove Qt 4 code (<a href='https://github.com/owncloud/client/pull/6025'>#6025</a>, <a href='https://github.com/owncloud/client/pull/5702'>#5702</a>, <a href='https://github.com/owncloud/client/pull/5505'>#5505</a>)</li>
<li>Harmonize source code style with clang-format (<a href='https://github.com/owncloud/client/pull/5732'>#5732</a>, )</li>
<li>Switch over to Qt 5 function pointer signal/slot syntax (<a href='https://github.com/owncloud/client/pull/6041'>#6041</a>)</li>
<li>Updater: Rudimentary support for beta channel (<a href='https://github.com/owncloud/client/pull/6048'>#6048</a>)</li> 
</ul>
Download:
<a href="https://download.owncloud.com/desktop/stable/ownCloud-2.4.0.XXXX-setup.exe">Windows</a> |
<a href="https://download.owncloud.com/desktop/stable/ownCloud-2.4.0.XXXX.pkg">Mac</a> |
<a href="https://software.opensuse.org/download/package?project=isv:ownCloud:desktop&amp;package=owncloud-client">Linux</a> |
<a href="https://download.owncloud.com/desktop/stable/owncloudclient-2.4.0.tar.xz">Sources</a> (<a href="https://download.owncloud.com/desktop/stable/owncloudclient-2.4.0.tar.xz.asc">PGP signature</a>)
<br/>Download testpilotcloud client:
<a href="https://download.owncloud.com/desktop/testing/testpilotcloud-2.4.0.XXXX-setup.exe">Windows</a> |
<a href="https://download.owncloud.com/desktop/testing/testpilotcloud-2.4.0.XXXX.pkg">Mac</a> |
