...
<p>If you are looking for information on encryption, <a href="https://owncloud.org/blog/how-owncloud-uses-encryption-to-protect-your-data/" target="_blank">see this blog</a>. For more general information around security, see our <a href="/faq#security" target="_blank">FAQ questions around security</a> and follow our development on <a href="https://owncloud.org/news" target="_blank">owncloud.org/news</a> to learn about <a href="https://statuscode.ch/2015/05/security-and-owncloud-8.1/" target="_blank">security improvements like those introduced in ownCloud 8.1</a> and <a href="https://owncloud.org/blog/hackerone-case-study-on-owncloud/">how others see our efforts</a>. For server owners, our documentation has a section with <a href="<?php echo $DOCUMENTATION_ADMIN; ?>configuration_server/harden_server.html" target="_blank">best practices and tips on securing an ownCloud server</a>.</p>
<div class="row">
<div class="span12">
