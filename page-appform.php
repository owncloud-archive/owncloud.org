...
<div class="row">
    <div class="col-md-10">
        ...
        Please note how you applied <a href="<?php echo $DOCUMENTATION_DEVEL; ?>app/publishing.html#app-guidelines">the app guidelines</a> and share your thoughts on why the app would be a great addition for the ownCloud ecosystem.
        </td>
        <td valign="top">
