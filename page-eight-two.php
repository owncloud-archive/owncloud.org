	...
	<div class="wrap container">
		<div class="row">
			...
			<div class="col-md-4 featureblock">
				...
				<p class="featuredesc">Admins now have the ability to send notifications to users, set limits on file retention in the trash and encrypt and decrypt data.</p>
			</div>
		</div>
	</div>
</div>
