...
If you want to talk to ownCloud users, contributors and fans, join the <a href="/promote" target="_blank">community conversation</a> over social media, the forums and other places. Most of our contributors are active on <a href="https://central.owncloud.org" target="_blank">central.owncloud.org </a>. Some are active in <a href="irc://#owncloud-dev@freenode.net" target="_blank">the ownCloud development IRC channel</a> on freenode.net, also accessible via <a href="https://webchat.freenode.net/?channels=owncloud-dev" target="_blank">webchat</a>. If you are looking for answers to questions, see <a href="/faq" target="_blank">the ownCloud FAQ</a> and our <a href="/support" target="_blank">support page</a>.
