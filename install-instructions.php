									...
									<div class="col-md-8">
										...
										<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-9 vmlist">
													<a href="https://www.techandme.se/machine-setup-owncloud/" target="_blank">Pre-configured Ubuntu 14.04 VM with Apache and MySQL</a>. Manages updates with script, can be automated.
												</div>
											</div>
										</div>
									</div>
