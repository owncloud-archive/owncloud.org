...
$SERVER_TESTING_VERSION ='9.0.1 RC';
$DOWNLOAD_SERVER_TAR_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.1RC1.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.1RC1.zip';
