...
/* VERSIONS */
$VERSIONS_SERVER_MAJOR_STABLE = '9.0';
$VERSIONS_SERVER_FULL_STABLE = '9.0.1';
$VERSIONS_SERVER_MAJOR_DEVELOPMENT = '9.1';
$VERSIONS_SERVER_MAJOR_DEV_DOCS = '9.1'; // Used in dev docs links
$VERSIONS_CLIENT_DESKTOP_STABLE_FULL = '2.1.1';
$VERSIONS_CLIENT_DESKTOP_STABLE_SHORT = '2.1'; // For use in documentation link
$VERSIONS_CLIENT_DESKTOP_TESTING = '2.2.0 beta1';
...
$VERSIONS_VM = '9.0.1-1.1-201604071824';
...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_WIN = $DOWNLOAD_CLIENT_DESKTOP_BASE.'ownCloud-2.1.1.5837-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_MAC = $DOWNLOAD_CLIENT_DESKTOP_BASE.'ownCloud-2.1.1.3107.pkg';
...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_SOURCES = $DOWNLOAD_CLIENT_DESKTOP_BASE.'owncloudclient-2.1.1.tar.xz';
...
$DOWNLOAD_CLIENT_DESKTOP_TEST_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'ownCloud-2.2.0.6020beta1-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_TEST_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'ownCloud-2.2.0.3297beta1.pkg';
...
$DOWNLOAD_CLIENT_DESKTOP_TESTPILOT_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'testpilotcloud-2.2.0.6021beta1-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_TESTPILOT_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'testpilotcloud-2.2.0.3298beta1.pkg';
...
$DOWNLOAD_CLIENT_DESKTOP_TEST_SOURCES= $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'owncloudclient-2.2.0beta1.tar.xz';
...
$DOWNLOAD_SERVER_TAR_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.1RC2.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.1RC2.zip';
