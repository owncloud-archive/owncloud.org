<?php
// Strings used throughout the ownCloud.org. 

// VERSIONS
$VERSIONS_SERVER_MAJOR_STABLE = '6';
$VERSIONS_SERVER_FULL_STABLE = '6.0.2';
$VERSIONS_SERVER_MAJOR_DEVELOPMENT = '7';
$VERSIONS_CLIENT_DESKTOP_STABLE_FULL = '1.5.3';

// DOCUMENTATION
$DOCUMENTATION_BASE = 'https://doc.owncloud.org/';
$DOCUMETNATION_DEVELOPER = $DOCUMENTATION_BASE.'/server/'.$VERSIONS_MAJOR_STABLE.'.0/developer_manual/';
$DOCUMETNATION_ADMIN = $DOCUMENTATION_BASE.'/server/'.$VERSIONS_MAJOR_STABLE.'.0/admin_manual/';
$DOCUMENTATION_USER = $DOCUMENTATION_BASE.'/server/'.$VERSIONS_MAJOR_STABLE.'.0/user_manual/';

// DOWNLOADS
$DOWNLOAD_PGP = $DOWNLOAD_BASE.'owncloud.asc';

$DOWNLOAD_CLIENT_DESKTOP_BASE = 'https://download.owncloud.com/desktop/stable/';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_WIN = $DOWNLOAD_CLIENT_DESKTOP_BASE.'ownCloud-1.5.3.2523-setup.exe';
...
$DOWNLOAD_SERVER_STABLE_ZIP_SHA256 = $DOWNLOAD_SERVER_BASE.'owncloud-'.$VERSIONS_SERVER_FULL_STABLE.'.zip.sha265';
