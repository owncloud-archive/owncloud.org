...
/* VERSIONS */
$VERSIONS_SERVER_MAJOR_STABLE = '7';
$VERSIONS_SERVER_FULL_STABLE = '7.0.4';
$VERSIONS_SERVER_MAJOR_DEVELOPMENT = '8';
$VERSIONS_SERVER_MAJOR_DEV_DOCS = '7'; // Used in dev docs links
$VERSIONS_CLIENT_DESKTOP_STABLE_FULL = '1.7.0';
$VERSIONS_CLIENT_DESKTOP_STABLE_SHORT = '1.7'; // For use in documentation link
$VERSIONS_CLIENT_DESKTOP_TESTING = '1.7.1 beta1';
...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_WIN = $DOWNLOAD_CLIENT_DESKTOP_BASE.'ownCloud-1.7.0.4162-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_STABLE_MAC = $DOWNLOAD_CLIENT_DESKTOP_BASE.'ownCloud-1.7.0.1490.pkg';
...
$DOWNLOAD_CLIENT_DESKTOP_STABLE_SOURCES = $DOWNLOAD_CLIENT_DESKTOP_BASE.'mirall-1.7.0.tar.bz2';
...
$DOWNLOAD_CLIENT_DESKTOP_TEST_WIN = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'ownCloud-1.7.1.4331beta1-setup.exe';
$DOWNLOAD_CLIENT_DESKTOP_TEST_MAC = $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'ownCloud-1.7.1.1594beta1.pkg';
...
$DOWNLOAD_CLIENT_DESKTOP_TEST_SOURCES= $DOWNLOAD_CLIENT_DESKTOP_TEST_BASE.'mirall-1.7.1beta1.tar.bz2';
