...
$SERVER_TESTING_VERSION ='9.0.0 RC 2';
$DOWNLOAD_SERVER_TAR_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.0RC2.tar.bz2';
$DOWNLOAD_SERVER_ZIP_TESTING ='http://download.owncloud.org/community/testing/owncloud-9.0.0RC2.zip';
