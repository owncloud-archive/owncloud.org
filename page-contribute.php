...
<div class="panel-group" id="accordionUser">
  <div class="panel panel-default">
	...
	<ul><li>Develop your own ownCloud app</li>
	  ...
	  <li>Learn to write ownCloud code.</li></ul>
	...
	<ul><li>We use <a href="https://github.com/owncloud">Github</a>, please get an account there and
...
(and don't hesitate to contact the mentor of the project you're interested in!)</p>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTranslate">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseWebsite">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseDesign">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapsePromote">
    ...
    <div id="collapsePromote" class="panel-collapse collapse">
      <div class="panel-body">
	Spread the word, tell your friends about it, write a blog post! Or <a href="http://owncloud.org/events">organize ownCloud events</a> 
