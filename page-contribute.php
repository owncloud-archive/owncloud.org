...
<p>You want to get an <strong>improvement</strong> in ownCloud? Found a <strong>problem</strong>? Want to <strong>help</strong> translate, promote or document ownCloud?</p>
...
<ul>
	...
	<li>Learn to write ownCloud code. We have <a href="https://github.com/owncloud/core/issues?labels=Junior+Job&state=open/">Junior Jobs</a> and a <a href="https://github.com/owncloud/core/wiki/GSoC,-GCI-and-OPW">project ideas page</a> with mentors. See below for how to get started.</li>
	...
	<li>Help out with the <a href="https://github.com/owncloud/www">website</a> and <a href="https://github.com/owncloud/documentation/blob/stable6/CONTRIBUTING.rst">write documentation</a> (contact tpn or deryo in the <a href="irc://#owncloud-dev@freenode.net">irc channel</a>)</li>
...
<p><em>TIP</em>: For an easy way to get involved, check the <a href="https://github.com/owncloud/core/issues?labels=Junior+Job&state=open/">Junior Jobs</a> and check out the <a href="https://github.com/owncloud/core/wiki/GSoC,-GCI-and-OPW">project ideas page</a> (and don't hesitate to contact the mentor of the project you're interested in!)</p>
<p><em>TIP</em>: If you are new to git, do the <a href="http://git-scm.com/course/svn.html">git crash course</a>. We use <a href="http://github.com/owncloud">github</a> for our collaborative development, and they have an excellent series of tutorials on <a href="https://help.github.com/">help.github.com</a>. Try the <em>'Set Up git'</em>, <em>'Fork a Repo'</em> and <em>'Be Social'</em> tutorials!</p>
<h2>Getting your code in ownCloud</h2>
<p>Once you have written or improved a piece of ownCloud code, you can submit it to us for review and inclusion. Read the Contribution, Design and Coding guidelines below to get an idea of what we are looking for and how it works.</p>
<p>in short, the steps are:</p>
<ol><li><em>(optional)</em> check if somebody is already doing something like this or look for others to work with you - this prevents duplication of efforts! Just ask around on the <a href="http://mailman.owncloud.org/mailman/listinfo/devel">development mailing list</a></li>
