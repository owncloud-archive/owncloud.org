...
<p><strong>Let's get you started.</strong></p>
<h2>How to make ownCloud awesome:</h2>
Get your code in ownCloud!
	<ul>
	  <li>Develop your own ownCloud app</li>
	  <li>Get a bug fixed</li>
	  <li>Improve the ownCloud Core</li>
	  <li>Or just learn to write ownCloud code.</li>
	</ul>
<p>Check our Contribution Guidelines below and find us <a href="irc://#owncloud-dev@freenode.net">on IRC</a> and our <a href="http://mailman.owncloud.org/mailman/listinfo/devel">mailing list</a>!</p>
But there is more you can do:
<ul>
	<li>Report an issue <a href="https://github.com/owncloud/core/issues">on our bug tracker</a></li>
	<li>Translate ownCloud <a href="https://www.transifex.com/projects/p/owncloud/">to your language</a></li>
