...
if(is_page('oc-news') || is_page('blogfeed')) { include roots_template_path(); } else {
  ...
  <body <?php body_class(); ?>>
    ...
    <?php if(is_page('5years') ||is_page('conf') || is_page('register')|| is_page('thankyou')) { // Handle conference layout ?>
    ...
    <?php if(is_page('getstarted')) { require get_template_directory().'/start-instructions.php'; } ?>
