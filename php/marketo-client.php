...
class Marketo {
  ...
  private $newsletter = array(
    'programId' => 2816801,
    'programName' => 'Newsletter Program'
  );

	function __construct (){
		$this->client = new Client([
        'base_uri' => 'https://038-KRL-592.mktorest.com/rest/v1/',
  ...
  private function getAccessToken() {
    $client = new Client([
      'base_uri' => 'https://038-KRL-592.mktorest.com/identity/'
    ]);

    $response = $client->request('get', 'oauth/token', [
      'query' => [
        'grant_type' => 'client_credentials',
        'client_id' => 'b9125f6d-9302-44df-b6a0-b17dd36b8a69',
        'client_secret' => 'BqFDTIZzSrOTPKfuMGgatiZJQhO1ZE94'
      ]
    ]);
