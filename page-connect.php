<div class="row col-md-12">
	...
	<p>Create your own private, secure “Dropbox” with an old laptop and an internet connection with <em>ownCloud Proxy</em>.</p>
...
<div class="row">
	...
	<div class="col-lg-8 col-md-7">
		<h2>What is it?</h2>
                ...
                <p><strong>ownCloud Proxy</strong>: Simply put, ownCloud Proxy enables you to take a laptop and an Internet connection, connect to your privately hosted ownCloud from anywhere, without requiring you to make any changes to your local network settings – no router configuration, no DNS entries, no domain name registration. The ownCloud Proxy service relies on a partner who provides the service for a fee. Right now, there is one partner, <a href="https://pagekite.net/" target="_blank">pageKite</a>. More are coming!</p>
        </div>
</div>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-12">
        ...
        <p>All of the security associated with ownCloud is at work when you use the ownCloud Proxy service. ownCloud is still run by you, on your computer. You can monitor what is happening, manage accounts, check the logs, use your own SSL certificates, enable automatic updates and more. The appliance pre-configures much of ownCloud for you. All you have to do is start the appliance, complete the setup and log into the web URL it provides. The ownCloud browser wizard at the provided URL will step you through logging in for the first time. Of course, as you configure accounts for others to share on your ownCloud, we recommend you use secure and complex passwords for all accounts.</p>
        <p>However, we want to be completely transparent about the nature of ownCloud Proxy. The ownCloud Proxy app is distributed and the source code is in the ownCloud repository for review in Github. The ownCloud Proxy service is provided by PageKite. All files transferred through the ownCloud Proxy service do pass through its data centers, and for a brief time are readable as the ownCloud Proxy service transfers incoming requests from SSL to <a href="https://pagekite.net/wiki/Floss/PageKiteProtocol/">a pageKite protocol</a> on the way to the private ownCloud Server. In theory, if someone wanted to, all files transferred to and from devices using the ownCloud Proxy service could – for that brief instant of time that they are being moved from the SSL terminated connection to the tunnel in memory – be read by someone with ownCloud Proxy service server access. While the risk is small, and our terms and conditions cover this situation, it is something we wanted to be clear about. However, there is no way for the ownCloud Proxy service to access your data on your private server, it can only broker a connection with your private server.</p>
        </div>
        <div class="col-md-12">
        ...
        <p>If, at any time, you want to stop using ownCloud Proxy, simply use the stop button in the GUI and then disable the app in the ownCloud admin interface and it will stop working permanently.</p>
        </div>
        <div class="col-md-12">
        <h3>Does ownCloud Proxy work with ownCloud Standard or Enterprise Subscriptions?</h3>
        <p>No, the ownCloud Proxy app and service are not designed to work with ownCloud subscriptions. The service architecture and bandwidth is intended for smaller ownCloud instances and sized accordingly.</p>
        </div>
        <div class="col-md-12">
        <h3>What if I want to dig a little deeper?</h3>
        <p>While we provide ownCloud Proxy and the ownCloud appliance to get you up and running fast, it is in no way limited. If you want to start configuring the components in the appliance for your use case, feel free. If you want to tune the database, or set up your own static IP address and domain name, and disable ownCloud connect? Go for it! And, for a real challenge, why not try an app from apps.owncloud.com, or write your own? ownCloud chat, ownCloud maps, ownCloud video streaming, ownCloud audio streaming – these are all apps built by the community. With ownCloud, the possibilities to explore are endless.</p>
        </div>
        <div class="col-md-12">
        <h3></h3>
        <p></p>
