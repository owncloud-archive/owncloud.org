...
<div class="row">
	<div class="col-md-12">
        ...
        <p>If, at any time, you want to stop using ownCloud Proxy, simply disable the app in the ownCloud admin interface and it will stop working permanently.</p>
        </div>
        <div class="col-md-12">
