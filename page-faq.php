...
<ul>
	...
	<ul>
		<li>ownCloud is designed to be very scalable, and be independent of the used storage system. We want it to work with petabytes of data and tens of thousands of users - and it does, organizations like CERN in Switzerland and big universities and University Networks run ownCloud with such amounts of data and users. </li>
...
<ul>
	<li>ownCloud can run on Raspberry Pi like development boards but is certainly not limited to low-end hardware. Worlds' largest on-premise cloud deployment services <a href="https://owncloud.com/sciebo-germanys-largest-cloud-project-500000-users-launches-today/" target="_blank">500,000 students on ownCloud</a> and terabytes of data are shared through ownCloud at organizations like the  <a href="https://cernbox.web.cern.ch/" target="_blank">atom smashers at CERN</a>. ownCloud co-founder Frank Karlitschek wrote a <a href="http://karlitschek.de/2015/03/scaling/" target="_blank">post about the scalability of ownCloud</a>.</li>
...
<ul>
	<li>ownCloud is an open-source project that can be easily hosted by any person allowing anybody to securely exchange files. Neither the ownCloud open source project nor ownCloud GmbH exert any legal or technical control over those domains. If you found a copyright infringement on a domain other than <a href="https://owncloud.org" target="_blank">owncloud.org</a> or <a href="https://owncloud.com" target="_blank">owncloud.com</a>, please try to contact the domain owner. ownCloud has no insight or control over ownCloud instances.</li>
</ul>
...
<ul>
	<li>Where home users can find <a href="#channels">the support resources they need</a> in the community, professional users can find <a href="https://owncloud.com/resources" target="_blank">resources developed by ownCloud GmbH</a> as well as the <a href="https://owncloud.com/get-started-standard-subscription" target="_blank">Standard Subscription</a> support option for ownCloud Server and the <a href="https://owncloud.com/products/enterprise" target="_blank">Enterprise Subscription</a> which adds functionality for integrating ownCloud in an enterprise infrastructure.
