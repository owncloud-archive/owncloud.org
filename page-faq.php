...
<ul>
	<li><strong>Core</strong> means part of ownCloud core, like sharing, gallery, external storage, encryption. These are integral parts of the ownCloud experience and problems in these apps will block releases. ownCloud, Inc. offers support on these to customers and while not all core functionality is maintained by employees, Inc. takes responsibility for stability and of the entirety of ownCloud core.</li>
	<li><strong>Official</strong> are apps which are quite well maintained and important for ownCloud users. They include the Calendar and Contacts. Being 'official', we deeply care about them and will try to have them available for new releases on release day, but they are still <strong>developed by volunteers</strong>. This also means there is no commercial support available from ownCloud, Inc. This often also that these apps do not work well on systems with large numbers of users or large amounts of data.</li>
