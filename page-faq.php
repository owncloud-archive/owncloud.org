...
<p>If you have made no modifications to the ownCloud code, the easiest way to comply with the AGPL is to have a small link to owncloud.org and note that users can find the code there. If you have made modifications, contributing these to ownCloud is sufficient from our point of view. If you don't want or can't do that, you have to provide a way for users to download the modifications you made to ownCloud, including any apps you wrote or integrated. Providing, upon request, a tarball, zip file or github repository is enough. Make sure they contain the copyright notice; the code has to be under the AGPLv3 or a compatible license like the <a href="http://opensource.org/licenses/MIT" target="_blank">MIT license</a>.</p>
<p>Artwork is exempt from these restrictions: you can have a branded ownCloud installation which links to owncloud.org in a subtle (but visible!) way. You do NOT have to release your artwork under the AGPLv3.</p>
