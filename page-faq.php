...
<p>Some examples:</p>
<ul>
<li>ownCloud apps (build in ownCloud apps as you would write following <a href="<?php echo $DOCUMENTATION_DEVELOPER; ?>/app/">the App Developer documentation</a>, using the public but internal API) are considered an integral part of ownCloud; writing an ownCloud app is thus considered modifying ownCloud and your ownCloud apps are subject to the requirements of the AGPLv3. The ownCloud <a href="#entcomparison">Enterprise Edition</a> provides <a href="#closedapps">an exception</a> as it is available under a proprietary license.</li>
<li>External apps like mobile or desktop clients, or apps running on another server and otherwise not part of ownCloud but using the external ownCloud OCS API as <a href="<?php echo $DOCUMENTATION_DEVELOPER; ?>/core/externalapi.html">you would find here</a> are NOT subject to the AGPLv3 and can be under any license you like.</li>
<li>Artwork is not subject to the AGPLv3: you can have a branded ownCloud installation which links to owncloud.org in a subtle (but visible!) way. You do NOT have to release your artwork under the AGPLv3.</li>
