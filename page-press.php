...
<div class="row">
	...
	<div class="col-md-3"><a href="/7"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/screenshots/newfeatures.png" style="width: 100%" alt="See what is new in ownCloud 7" class="img-thumbnail"></a></div>
</div>
