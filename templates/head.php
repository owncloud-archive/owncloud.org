...
<head>
	...
	<?php wp_head(); ?>
	<?php if(is_page('5years') || is_page('conf') || is_page('register')|| is_page('thankyou')) { ?><link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/conf.css"><?php } ?>
	<?php if(is_page('news')) { ?>
