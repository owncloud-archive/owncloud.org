<header class="banner navbar navbar-default navbar-static-top" role="banner">
  ...
  <?php if(is_page('homepage')): ?>
	<div class="container-fluid teaser-area">
		...
		<a href="https://owncloud.org/blog/owncloud-connects-business-users/"><img src="<?php bloginfo('template_directory'); ?>/assets/img/events/business_event_small.png" class="home-event-img" /></a>
	</div>
  <?php endif; ?>
</header>
