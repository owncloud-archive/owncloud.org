<header class="banner navbar navbar-default navbar-static-top" role="banner">
  ...
  <?php if(is_page('homepage')): ?>
	<div class="container-fluid teaser-area">
		...
		<a href="https://https://owncloud.org/blog/new-in-owncloud-9-1/"><img src="<?php bloginfo('template_directory'); ?>/assets/img/events/nineone-note.png" class="home-event-img" /></a>
	</div>
  <?php endif; ?>
</header>
