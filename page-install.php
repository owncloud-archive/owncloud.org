<div class="row">
  <div class="col-md-6">
    ...
    <br />
    <div class="btn-group">
      <a data-placement="left" class="btn btn-primary btn-large" href="#" role="button" data-toggle="modal" rel="tooltip" title="For server owners"><i class="icon-archive"></i> Archive File</br><small>For server owners</small></a>
      <a class="btn btn-default btn-large" data-placement="left" href="#" role="button" data-toggle="modal" rel="tooltip" title="Best for shared hosts"><i class="icon-code"></i> Web Installer</br><small>For shared hosts</small></a>
      <a class="btn btn-default btn-large" data-placement="left" href="#" role="button" data-toggle="modal" rel="tooltip" title="Provides automated updates"><i class="icon-linux"></i> Packages</br><small>For auto updates</small></a>
    </div>
    <br />
    <br />
  </div>
...
<div class="row">
  <div class="col-md-6">
    ...
    <div class="btn-group">
      ...
      <a href="<?php echo $DOWNLOAD_CLIENT_DESKTOP_STABLE_MAC; ?>" class="btn btn-large btn-default<?php if(os_info() == 'Mac'){ echo ' btn-primary'; } ?>"><i class="icon-apple"></i> Mac<br /><small>Mac OSX 10.6+, 6</small></a>
