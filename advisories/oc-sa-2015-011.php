...
<p>In such cases an adversary with knowledge of the sharing link to a deleted item may be able to access all files of the user and not only the original shared directory.</p>
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>7.0.7</strong> (CVE-2015-5954)</li>
<li>ownCloud Server &lt; <strong>8.0.5</strong> (CVE-2015-5954)</li>
<li>ownCloud Server &lt; <strong>6.0.9</strong> (CVE-2015-5954)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>All usages of the <code>getPath</code> function has been revised and corrected.</p>
<p>Furthermore, ownCloud 8.2 will feature another security hardening where instead of returning <code>null</code> for invalid files now an exception is thrown. In case of an exception ownCloud will stop the script execution and also static source code analysis will make developers aware of such situations.</p>
</p>
