...
<p>HackerOne report: <a href="https://hackerone.com/reports/146067">146067</a></p>
        <h3>Description</h3>
        <p>The restore capability of ownCloud was not verifying whether an user has only read-only access to a share. Thus an user with read-only access was able to restore old versions.</p>
</p>
