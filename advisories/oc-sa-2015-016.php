...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <h3>Description</h3>
        <p><p>The ownCloud Desktop Client was vulnerable against MITM attacks until version 2.0.0 in combination with self-signed certificates. To be exploitable the following conditions have to be met:</p>
...
<p>ownCloud highly advises affected users to update affected clients as soon as possible to ensure data integrity and confidentiality. Users with such setup and that have experienced such a behaviour are encouraged to change their ownCloud passwords.</p>
<p>This is a partial regression of oC-SA-2015-009 (CVE-2015-4456).</p>
        ...
        <h3>Action Taken</h3>
        <p><p>To protect our users ownCloud has issued the 2.0.1 client which addresses this issue. Users of older ownCloud clients are encouraged to import their certificate into the local system trust store.</p>
</p>
