...
<p>While ownCloud advises browsers to disable inline JavaScript execution this vulnerability is caused by a <code>eval</code> like construct which is currently allowed in our default Content-Security-Policy, thus this is effectively exploitable in any browser.</p>
</p>
        <h3>Affected Software</h3>
        <ul>
            <li>ownCloud Server &lt; <strong>7.0.5</strong> (CVE-2015-3011)</li>
<li>ownCloud Server &lt; <strong>6.0.7</strong> (CVE-2015-3011)</li>
<li>ownCloud Server &lt; <strong>5.0.19</strong> (CVE-2015-3011)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>The user input is now properly sanitised before provided back to the user. Furthermore, with ownCloud 8.2 the default Content-Security-Policy will forbid any <code>eval</code> like constructs by default as an additional layer of defense.</p>
</p>
