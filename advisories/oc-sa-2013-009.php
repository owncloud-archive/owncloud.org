...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>4.5.8</strong> (CVE-2013-1850)</li>
<li>ownCloud Server &lt; <strong>4.0.13</strong> (CVE-2013-1850)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>It is recommended that all instances are upgraded to ownCloud Server 4.5.8 or 4.0.13.</p>
</p>
