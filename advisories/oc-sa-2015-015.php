...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>8.1.1</strong> (CVE-2015-6670)</li><li>ownCloud Server &lt; <strong>8.0.6</strong> (CVE-2015-6670)</li><li>ownCloud Server &lt; <strong>7.0.8</strong> (CVE-2015-6670)</li>
        </ul>
        <h3>Action Taken</h3>
