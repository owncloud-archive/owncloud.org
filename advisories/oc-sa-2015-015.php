...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p>CWE: <a href="https://cwe.mitre.org/data/definitions/639.html">InformationAuthorization Bypass Through User-Controlled Key (CWE-639)</a></p>
        <h3>Description</h3>
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>8.1.1</strong> (CVE assignment pending)</li><li>ownCloud Server &lt; <strong>8.0.6</strong> (CVE assignment pending)</li><li>ownCloud Server &lt; <strong>7.0.8</strong> (CVE assignment pending)</li>
        </ul>
        <h3>Action Taken</h3>
        <p><p>The vulnerable component has been fixed.</p></p>
