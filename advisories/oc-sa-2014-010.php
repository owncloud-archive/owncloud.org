...
<p>ownCloud advises browsers to disable inline JavaScript execution due to the used Content-Security-Policy, this vulnerability is therefore likely not exploitable if you use a browser that <a href="http://caniuse.com/contentsecuritypolicy">fully supports</a> the current CSP standard.</p>
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>6.0.3</strong> (CVE-2014-3832, CVE-2014-3833)</li>
<li>ownCloud Server &lt; <strong>5.0.16</strong> (CVE-2014-3833)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>ownCloud offers the functions <code>p()</code> which encodes potential dangerous input using `htmlspecialchars()`. We have reviewed whether the potential insecure pendant <code>print_unescaped()</code> was used in other places and replaced unneeded occurrences with the safe variant.</p>
<p>This review helped us to discover vulnerabilities in the following components.</p>
<strong>stable6</strong><ul><li>Gallery (stored) (CVE-2014-3833)</li><li>ownCloud core (stored + reflected) (CVE-2014-3833)</li><li>Documents (stored) (CVE-2014-3832)</li></ul><strong>stable5</strong><ul><li>Gallery (stored) (CVE-2014-3833)</li><li>ownCloud core (stored + reflected) (CVE-2014-3833)</li></ul></p>
