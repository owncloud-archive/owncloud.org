...
<p>If the ownCloud instance is able to access external FTP servers this effectively allows an adversary to login without providing valid credentials, if the "user_external" FTP backend has been enabled and configured.</p>
</p>
        <h3>Affected Software</h3>
        <ul>
            <li>ownCloud Server &lt; <strong>6.0.6</strong> (CVE-2014-9045)</li>
<li>ownCloud Server &lt; <strong>5.0.18</strong> (CVE-2014-9045)</li>
