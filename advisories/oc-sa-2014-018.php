...
<p>Please contact security@owncloud.com if you have proof that you've been attacked using this vulnerability.</p>
</p>
        <h3>Affected Software</h3>
        <ul>
            <li>ownCloud Server &lt; <strong>6.0.4</strong> (CVE-2014-4929)</li>
<li>ownCloud Server &lt; <strong>5.0.17</strong> (CVE-2014-4929)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>The ownCloud team has taken the following efforts to prevent further such attacks in the future:</p>
<ul><li>All usages of potential dangerous functions including files in core have been reviewed.</li><li>All insecure usages of those functions have been fixed and deprecated, the specific parts routing component will be rewritten for ownCloud 8 to further harden the security.</li><li>The setup routine has been refactored. It will be no longer possible to call it directly beginning with ownCloud 7.</li></ul></p>
