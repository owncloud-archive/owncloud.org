...
<div class="row">
	...
	<div class="col-md-8">
		...
		<h3>Description</h3>
		<p><p>Due to not properly sanitizing the LDAP queries an attacker is able to:<ul><li>Gain information about existing LDAP users</li><li>Modify the login query, e.g. with a wildcard</li></ul></p></p>
		<h3>Affected Software</h3>
		<ul>
			<li>ownCloud Server < <strong>6.0.2</strong> (CVE-2014-2047)</li><li>ownCloud Server < <strong>5.0.15</strong> (CVE-2014-2049)</li>
		</ul>
		<h3>Action Taken</h3>
		<p><p>All LDAP queries have been reviewed and proper sanitization added.</p></p>
