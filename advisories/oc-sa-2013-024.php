...
<p>Note: Successful exploitation of this privilege escalation requires the “calendar” app to be enabled (enabled by default).</p>
        ...
        <ul>
            <li>ownCloud Server &lt; <strong>5.0.6</strong> (CVE-2013-2043)</li>
<li>ownCloud Server &lt; <strong>4.5.11</strong> (CVE-2013-2043)</li>

        </ul>
        <h3>Action Taken</h3>
        <p><p>It is recommended that all instances are upgraded to ownCloud Server 5.0.6 or 4.5.11.</p>
</p>
