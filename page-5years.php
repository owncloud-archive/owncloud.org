...
<div class="row conf-info">
	<div class="col-md-4  col-md-offset-2">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/img/5years/5years.svg" alt="logo" />
	</div>
	<div class="col-md-6">
...
<div class="row conf-partners">
	<div class="col-sm-6">
		...
		<p>–contributor since 2011 <i>Jakob Sack</i>, Germany</p>
	</div>
	<div class="col-sm-6">
...
<div class="row conf-partners">
	<div class="col-sm-6">
		...
		<p>–ownCloud user since 2013 <i>John Thieling</i>, USA</p>
	</div>
	<div class="col-sm-6">
		<p>"I use ownCloud as a lazy way to avoid having to write a "Downloads" page. Just share the folder via a link and include the link in the web page. Awesome."</p>
		<p>–ownCloud user since 2013 <i>"Robin Jacobs"</i>, Europe</p>
	</div>
</div>
<hr>
<div class="row conf-partners">
	<div class="col-sm-6">
		...
		<p>–ownCloud user since 2013 <i>Antoine Guilloux</i>, France</p>
	</div>
	<div class="col-sm-6">
		<p>"I simply love the community which was roughly 45-50 contributors when I had joined and is now touching 200.
		So, a very very happy ownCloud! You are our 5 year old but an extremely mature kid now</p>
		<p>–ownCloud contributor since 2012 <i>Raghu Nayyar</i>, India</p>
	</div>
</div>
<hr>
<div class="row conf-partners">
