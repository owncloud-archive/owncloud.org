...
<div class="row page-content-header">
  <div class="col-sm-7">
    ...
    <p>If you'd like to stay up to date with ownCloud news you could also <a href="/newsletter">subscribe to our newsletter</a>!</p>
  </div>
</div>
...
<div class="row">
    ...
    <div class="sidebar col-sm-4 col-sm-offset-1">
      ...
      echo('<h2><i class="icon-cloud"></i> ownCloud News</h2>');
