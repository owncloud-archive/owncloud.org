...
<p>With millions of ownCloud users, there is a wide variety of needs and requirements. To give our users more flexibility in choosing an ownCloud version which fits their needs, we offer Release Channels. Below you can find and pick the best Channel for you. We recommend using Linux packages if possible.</p>
  <table class="table table-striped">
    ...
    <tr>
      ...
      <td class="info">This channel only delivers versions that have proven their stability in the Release channel for quite some time.
That does imply that these release are not bug free, but they are well known and its possible to work around.

Obviously this channel lacks the latest features, but offers the maximum of stability.</td>
