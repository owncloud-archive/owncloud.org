...
<!--		    <a href="https://download.owncloud.org/download/repositories/9.0/owncloud/">9.0</a> - coming when 9.0.1 is out-->
...
<div class="row">
    <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12">
        ...
        <p>To <em>upgrade in the safest way possible</em>, always update to the latest minor release before upgrading to a new version. As an extreme example, to upgrade from 7.0 all the way to 9.0, upgrade 7.0.x to 7.0.13, then upgrade to 8.0.11, 8.1.7, 8.2.4, then 9.0.1.</p>
    </div>
