...
<div class="row 2-column-lg-md-sm conf-info">
	...
	<div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
		...
		<p>Join us for keynotes, lightning talks and workshops:</p>
		<ul>
...
<div class="row 2-column-lg-md-sm conf-about">
	<div class="col-lg-6 col-md-6 col-xs-12 col-sm-6 .col-md-offset-3 .col-lg-offset-3">
		<h2>About</h2>
